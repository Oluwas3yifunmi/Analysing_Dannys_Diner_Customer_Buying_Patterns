...
![](6.png)
I was asked to look into the buying pattern of each customer after they became a member of the diner. I utilized my data manipulation skills by using the **SELECT FROM and WHERE** statements, using the **SELECT** statement, i was able to extract the list of items purchased after each customer became a member and i discovered that **Customer A** became a member of the diner on 2010-01-07 and afterwards made an order for **Ramen** on 2010-01-10, **Customer B** became a member of the diner on 2010-01-
